...
public sealed class CurrentUserServiceTest
{
    [Fact]
    public void WhenGettingUser_WhitNameIdentifierClaimInContext_NameIdentifierMustBeReturned()
    {
        //ARRANGE
        var httpContextAccessor = new Mock<IHttpContextAccessor>();
        var identity = new ClaimsIdentity(new List<Claim>() { new Claim(ClaimTypes.NameIdentifier, "Kevin") },
        ...
        //ASSERT
        Assert.Equal(userId, contextUser.Identity.Name);
    }
}
