...
namespace TravelInspiration.API.Shared.Persistence.Migrations
{
    ...
    [Migration("20260219190113_AddingIsSuggestedByAIToStop")]
    partial class AddingIsSuggestedByAIToStop
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(6578),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(6585),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(7138),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(7158),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(7172),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(7186),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(7202),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 19, 19, 1, 13, 260, DateTimeKind.Utc).AddTicks(7218),
