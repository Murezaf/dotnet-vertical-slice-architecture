...
namespace TravelInspiration.API.Shared.Persistence.Migrations
{
    ...
    [Migration("20260217075954_InitialMigration")]
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(7878),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(7880),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(8094),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(8100),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(8105),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(8109),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(8114),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2026, 2, 17, 7, 59, 54, 661, DateTimeKind.Utc).AddTicks(8118),
